function Balance({ transactions = [] }) {
    ...
    return (
        <section className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-2xl bg-white p-5 shadow-sm duration-300 dark:bg-slate-800">
                <p className="text-sm text-slate-500 dark:text-slate-100">Transactions</p>
                <strong className="mt-2 block text-2xl text-slate-800 dark:text-slate-100">{transactions.length}</strong>
            </div>
        </section>
    )
}
